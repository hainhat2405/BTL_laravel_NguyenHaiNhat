<div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{URL::to('/dashboard')}}" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Trang chủ</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Loại sản phẩm</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{route('indexLSP')}}" class="dropdown-item">Danh sách loại sản phẩm</a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Đơn hàng</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{URL::to('/manage_order')}}" class="dropdown-item">Quản lý đơn hàng</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Bài viết</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{URL::to('/blog')}}" class="dropdown-item">Quản lý bài viết</a>
                            <a href="{{URL::to('/add-blog')}}" class="dropdown-item">Thêm bài viết</a>
                        </div>
                    </div>
